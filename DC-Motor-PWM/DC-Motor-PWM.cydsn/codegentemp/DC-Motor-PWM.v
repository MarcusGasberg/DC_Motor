...
module top ;
	...
	wire [0:0] tmpOE__FW_Pin_net;
	wire [0:0] tmpFB_0__FW_Pin_net;
	wire [0:0] tmpIO_0__FW_Pin_net;
	wire [0:0] tmpINTERRUPT_0__FW_Pin_net;
	electrical [0:0] tmpSIOVREF__FW_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("390e8e7a-5b77-4684-b3cd-d75e7ea928b5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		FW_Pin
		 (.oe(tmpOE__FW_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__FW_Pin_net[0:0]}),
		  .io({tmpIO_0__FW_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__FW_Pin_net),
		  .interrupt({tmpINTERRUPT_0__FW_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__FW_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BW_Pin_net;
	wire [0:0] tmpFB_0__BW_Pin_net;
	wire [0:0] tmpIO_0__BW_Pin_net;
	wire [0:0] tmpINTERRUPT_0__BW_Pin_net;
	electrical [0:0] tmpSIOVREF__BW_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("1757ebae-2955-4326-9b87-0bf755695f06"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BW_Pin
		 (.oe(tmpOE__BW_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BW_Pin_net[0:0]}),
		  .io({tmpIO_0__BW_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__BW_Pin_net),
		  .interrupt({tmpINTERRUPT_0__BW_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BW_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
