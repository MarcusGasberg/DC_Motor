...
/* BW_Pin */
#define BW_Pin__0__INTTYPE CYREG_PICU0_INTTYPE1
#define BW_Pin__0__MASK 0x02u
#define BW_Pin__0__PC CYREG_PRT0_PC1
#define BW_Pin__0__PORT 0u
#define BW_Pin__0__SHIFT 1u
#define BW_Pin__AG CYREG_PRT0_AG
#define BW_Pin__AMUX CYREG_PRT0_AMUX
#define BW_Pin__BIE CYREG_PRT0_BIE
#define BW_Pin__BIT_MASK CYREG_PRT0_BIT_MASK
#define BW_Pin__BYP CYREG_PRT0_BYP
#define BW_Pin__CTL CYREG_PRT0_CTL
#define BW_Pin__DM0 CYREG_PRT0_DM0
#define BW_Pin__DM1 CYREG_PRT0_DM1
#define BW_Pin__DM2 CYREG_PRT0_DM2
#define BW_Pin__DR CYREG_PRT0_DR
#define BW_Pin__INP_DIS CYREG_PRT0_INP_DIS
#define BW_Pin__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define BW_Pin__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define BW_Pin__LCD_EN CYREG_PRT0_LCD_EN
#define BW_Pin__MASK 0x02u
#define BW_Pin__PORT 0u
#define BW_Pin__PRT CYREG_PRT0_PRT
#define BW_Pin__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define BW_Pin__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define BW_Pin__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define BW_Pin__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define BW_Pin__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define BW_Pin__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define BW_Pin__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define BW_Pin__PS CYREG_PRT0_PS
#define BW_Pin__SHIFT 1u
#define BW_Pin__SLW CYREG_PRT0_SLW

/* FW_Pin */
#define FW_Pin__0__INTTYPE CYREG_PICU0_INTTYPE0
#define FW_Pin__0__MASK 0x01u
#define FW_Pin__0__PC CYREG_PRT0_PC0
#define FW_Pin__0__PORT 0u
#define FW_Pin__0__SHIFT 0u
#define FW_Pin__AG CYREG_PRT0_AG
#define FW_Pin__AMUX CYREG_PRT0_AMUX
#define FW_Pin__BIE CYREG_PRT0_BIE
#define FW_Pin__BIT_MASK CYREG_PRT0_BIT_MASK
#define FW_Pin__BYP CYREG_PRT0_BYP
#define FW_Pin__CTL CYREG_PRT0_CTL
#define FW_Pin__DM0 CYREG_PRT0_DM0
#define FW_Pin__DM1 CYREG_PRT0_DM1
#define FW_Pin__DM2 CYREG_PRT0_DM2
#define FW_Pin__DR CYREG_PRT0_DR
#define FW_Pin__INP_DIS CYREG_PRT0_INP_DIS
#define FW_Pin__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define FW_Pin__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define FW_Pin__LCD_EN CYREG_PRT0_LCD_EN
#define FW_Pin__MASK 0x01u
#define FW_Pin__PORT 0u
#define FW_Pin__PRT CYREG_PRT0_PRT
#define FW_Pin__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define FW_Pin__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define FW_Pin__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define FW_Pin__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define FW_Pin__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define FW_Pin__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define FW_Pin__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define FW_Pin__PS CYREG_PRT0_PS
#define FW_Pin__SHIFT 0u
#define FW_Pin__SLW CYREG_PRT0_SLW
...
/* Pin_PWM */
#define Pin_PWM__0__INTTYPE CYREG_PICU1_INTTYPE7
#define Pin_PWM__0__MASK 0x80u
#define Pin_PWM__0__PC CYREG_PRT1_PC7
#define Pin_PWM__0__PORT 1u
#define Pin_PWM__0__SHIFT 7u
